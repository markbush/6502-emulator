...
public class CPU6502 : Chip {
  ...
  func perform(_ instruction:CPU6502Instruction) {
    ...
    case .I_DATA_to_S: sp.value = data.value
      // Arithmetic
    case .I_ADC:
  ...
  static let InstructionDecode:[[[CPU6502Instruction]]] = [
    ...
    [ // 84 STY ZP
      [.I_PC_to_ADDR_B, .I_PC_INCR], // Read PC (for ADL)
      [.I_DATA_to_ADL, .I_Y_to_DATA, .I_AD_to_ADDR_B, .I_WRITE], // Write Y
      [.I_PC_to_ADDR_B, .I_NEXT_OP, .I_PC_INCR] // Next OP
    ],
    [ // 85 STA ZP
      [.I_PC_to_ADDR_B, .I_PC_INCR], // Read PC (for ADL)
    ...
    [ // 8c STY Abs
      [.I_PC_to_ADDR_B, .I_PC_INCR], // Read PC (for ADL)
      [.I_DATA_to_ADL, .I_PC_to_ADDR_B, .I_PC_INCR], // Read ADH
      [.I_DATA_to_ADH, .I_Y_to_DATA, .I_AD_to_ADDR_B, .I_WRITE], // Write Y
      [.I_PC_to_ADDR_B, .I_NEXT_OP, .I_PC_INCR] // Next OP
    ],
    [ // 8d STA Abs
      [.I_PC_to_ADDR_B, .I_PC_INCR], // Read PC (for ADL)
    ...
    [ // 96 STX ZP,Y
      [.I_PC_to_ADDR_B, .I_PC_INCR], // Read PC (for ADL)
      [.I_DATA_to_ADL, .I_AD_to_ADDR_B, .I_ADL_plus_Y], // Save ADL, ADL+Y, unused read
      [.I_X_to_DATA, .I_AD_to_ADDR_B, .I_WRITE], // Write X
      [.I_PC_to_ADDR_B, .I_NEXT_OP, .I_PC_INCR] // Next OP
    ],
    [ // 97
      []
    ...
    [ // 9a TXS
      [.I_PC_to_ADDR_B], // Arg - discard, suppress PC incr
      [.I_X_to_DATA, .I_DATA_to_S, .I_PC_to_ADDR_B, .I_NEXT_OP, .I_PC_INCR] // X to S, Next OP
    ],
    [ // 9b
      []
    ],
    ...
    [ // e8 INX
      [.I_PC_to_ADDR_B], // Arg - discard, suppress PC incr
      [.I_X_to_DATA, .I_INC, .I_DATA_to_X, .I_PC_to_ADDR_B, .I_NEXT_OP, .I_PC_INCR] // Increment X, Next OP
    ],
    [ // e9 SBC Imm
      [.I_PC_to_ADDR_B, .I_PC_INCR], // Read PC (for Arg)
      [.I_SBC, .I_PC_to_ADDR_B, .I_NEXT_OP, .I_PC_INCR] // Subtract from A, Next OP
