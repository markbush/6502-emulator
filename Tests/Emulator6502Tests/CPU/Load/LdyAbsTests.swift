...
final class LdyAbsTests: XCTestCase {
  func testLdyAbsPositive() {
    print("debug: testLdyAbsPositive")
    let pins = Pins()
    ...
    memory[TestHelper.RES_ADDR] = TestHelper.LDYAbs
    ...
    XCTAssertEqual(pins.data.value, TestHelper.LDYAbs)

    print("debug: perform LDY Abs")
    // decode OP - fetch ADL
    TestHelper.cycle(cpu, pins: pins, mem: memory)
    XCTAssertEqual(cpu.ir.value, TestHelper.LDYAbs)
  ...
  func testLdyAbsNegative() {
    print("debug: testLdyAbsNegative")
    let pins = Pins()
  ...
  func testLdyAbsPositiveOverflow() {
    print("debug: testLdyAbsPositiveOverflow")
    let pins = Pins()
  ...
  func testLdyAbsNegativeOverflow() {
    print("debug: testLdyAbsNegativeOverflow")
    let pins = Pins()
