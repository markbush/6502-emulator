...
final class LdaZpTests: XCTestCase {
  func testLdaZpPositive() {
    print("debug: testLdaZpPositive")
    let pins = Pins()
    ...
    memory[TestHelper.RES_ADDR] = TestHelper.LDAZp
    ...
    XCTAssertEqual(pins.data.value, TestHelper.LDAZp)

    print("debug: perform LDA Zp")
    // decode OP - fetch ADL
    TestHelper.cycle(cpu, pins: pins, mem: memory)
    XCTAssertEqual(cpu.ir.value, TestHelper.LDAZp)
  ...
  func testLdaZpNegative() {
    print("debug: testLdaZpNegative")
    let pins = Pins()
  ...
  func testLdaZpPositiveOverflow() {
    print("debug: testLdaZpPositiveOverflow")
    let pins = Pins()
  ...
  func testLdaZpNegativeOverflow() {
    print("debug: testLdaZpNegativeOverflow")
    let pins = Pins()
