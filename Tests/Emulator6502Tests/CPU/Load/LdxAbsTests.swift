...
final class LdxAbsTests: XCTestCase {
  func testLdxAbsPositive() {
    print("debug: testLdxAbsPositive")
    let pins = Pins()
    ...
    memory[TestHelper.RES_ADDR] = TestHelper.LDXAbs
    ...
    print("debug: perform LDX Abs")
    // decode OP - fetch ADL
    TestHelper.cycle(cpu, pins: pins, mem: memory)
    XCTAssertEqual(cpu.ir.value, TestHelper.LDXAbs)
  ...
  func testLdxAbsNegative() {
    print("debug: testLdxAbsNegative")
    let pins = Pins()
  ...
  func testLdxAbsPositiveOverflow() {
    print("debug: testLdxAbsPositiveOverflow")
    let pins = Pins()
  ...
  func testLdxAbsNegativeOverflow() {
    print("debug: testLdxAbsNegativeOverflow")
    let pins = Pins()
