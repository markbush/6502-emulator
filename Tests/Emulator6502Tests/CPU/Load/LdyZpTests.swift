...
final class LdyZpTests: XCTestCase {
  func testLdyZpPositive() {
    print("debug: testLdyZpPositive")
    let pins = Pins()
    ...
    memory[TestHelper.RES_ADDR] = TestHelper.LDYZp
    ...
    XCTAssertEqual(pins.data.value, TestHelper.LDYZp)

    print("debug: perform LDY Zp")
    // decode OP - fetch ADL
    TestHelper.cycle(cpu, pins: pins, mem: memory)
    XCTAssertEqual(cpu.ir.value, TestHelper.LDYZp)
  ...
  func testLdyZpNegative() {
    print("debug: testLdyZpNegative")
    let pins = Pins()
  ...
  func testLdyZpPositiveOverflow() {
    print("debug: testLdyZpPositiveOverflow")
    let pins = Pins()
  ...
  func testLdyZpNegativeOverflow() {
    print("debug: testLdyZpNegativeOverflow")
    let pins = Pins()
