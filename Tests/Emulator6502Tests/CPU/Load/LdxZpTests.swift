...
final class LdxZpTests: XCTestCase {
  func testLdxZpPositive() {
    print("debug: testLdxZpPositive")
    let pins = Pins()
  ...
  func testLdxZpNegative() {
    print("debug: testLdxZpNegative")
    let pins = Pins()
  ...
  func testLdxZpPositiveOverflow() {
    print("debug: testLdxZpPositiveOverflow")
    let pins = Pins()
  ...
  func testLdxZpNegativeOverflow() {
    print("debug: testLdxZpNegativeOverflow")
    let pins = Pins()
