...
final class CmpZpTests: XCTestCase {
  func testCmpZpPositive() {
    print("debug: testCmpZpPositive")
    let pins = Pins()
    ...
    memory[TestHelper.RES_ADDR] = TestHelper.CMPZp
    ...
    XCTAssertEqual(pins.data.value, TestHelper.CMPZp)

    print("debug: perform CMP Zp")
    // decode OP - fetch ADL
    TestHelper.cycle(cpu, pins: pins, mem: memory)
    XCTAssertEqual(cpu.ir.value, TestHelper.CMPZp)
  ...
  func testCmpZpNegative() {
    print("debug: testCmpZpNegative")
    let pins = Pins()
  ...
  func testCmpZpPositiveOverflow() {
    print("debug: testCmpZpPositiveOverflow")
    let pins = Pins()
  ...
  func testCmpZpNegativeOverflow() {
    print("debug: testCmpZpNegativeOverflow")
    let pins = Pins()
