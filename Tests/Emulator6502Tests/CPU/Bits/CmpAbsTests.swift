...
final class CmpAbsTests: XCTestCase {
  func testCmpAbsPositive() {
    print("debug: testCmpAbsPositive")
    let pins = Pins()
  ...
  func testCmpAbsNegative() {
    print("debug: testCmpAbsNegative")
    let pins = Pins()
  ...
  func testCmpAbsPositiveOverflow() {
    print("debug: testCmpAbsPositiveOverflow")
    let pins = Pins()
  ...
  func testCmpAbsNegativeOverflow() {
    print("debug: testCmpAbsNegativeOverflow")
    let pins = Pins()
