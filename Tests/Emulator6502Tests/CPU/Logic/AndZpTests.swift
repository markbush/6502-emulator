...
final class AndZpTests: XCTestCase {
  func testAndZpPositive() {
    print("debug: testAndZpPositive")
    let pins = Pins()
    ...
    memory[TestHelper.RES_ADDR] = TestHelper.ANDZp
    ...
    XCTAssertEqual(pins.data.value, TestHelper.ANDZp)

    print("debug: perform AND Zp")
    // decode OP - fetch ADL
    TestHelper.cycle(cpu, pins: pins, mem: memory)
    XCTAssertEqual(cpu.ir.value, TestHelper.ANDZp)
  ...
  func testAndZpNegative() {
    print("debug: testAndZpNegative")
    let pins = Pins()
  ...
  func testAndZpPositiveOverflow() {
    print("debug: testAndZpPositiveOverflow")
    let pins = Pins()
  ...
  func testAndZpNegativeOverflow() {
    print("debug: testAndZpNegativeOverflow")
    let pins = Pins()
