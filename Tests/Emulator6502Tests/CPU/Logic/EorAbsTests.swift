...
final class EorAbsTests: XCTestCase {
  func testEorAbsPositive() {
    print("debug: testEorAbsPositive")
    let pins = Pins()
    ...
    memory[TestHelper.RES_ADDR] = TestHelper.EORAbs
    ...
    XCTAssertEqual(pins.data.value, TestHelper.EORAbs)

    print("debug: perform EOR Abs")
    // decode OP - fetch ADL
    TestHelper.cycle(cpu, pins: pins, mem: memory)
    XCTAssertEqual(cpu.ir.value, TestHelper.EORAbs)
  ...
  func testEorAbsNegative() {
    print("debug: testEorAbsNegative")
    let pins = Pins()
  ...
  func testEorAbsPositiveOverflow() {
    print("debug: testEorAbsPositiveOverflow")
    let pins = Pins()
  ...
  func testEorAbsNegativeOverflow() {
    print("debug: testEorAbsNegativeOverflow")
    let pins = Pins()
