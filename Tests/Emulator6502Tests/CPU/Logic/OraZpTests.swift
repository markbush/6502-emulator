...
final class OraZpTests: XCTestCase {
  func testOraZpPositive() {
    print("debug: testOraZpPositive")
    let pins = Pins()
    ...
    memory[TestHelper.RES_ADDR] = TestHelper.ORAZp
    ...
    XCTAssertEqual(pins.data.value, TestHelper.ORAZp)

    print("debug: perform ORA Zp")
    // decode OP - fetch ADL
    TestHelper.cycle(cpu, pins: pins, mem: memory)
    XCTAssertEqual(cpu.ir.value, TestHelper.ORAZp)
  ...
  func testOraZpNegative() {
    print("debug: testOraZpNegative")
    let pins = Pins()
  ...
  func testOraZpPositiveOverflow() {
    print("debug: testOraZpPositiveOverflow")
    let pins = Pins()
  ...
  func testOraZpNegativeOverflow() {
    print("debug: testOraZpNegativeOverflow")
    let pins = Pins()
