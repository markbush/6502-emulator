...
final class EorZpTests: XCTestCase {
  func testEorZpPositive() {
    print("debug: testEorZpPositive")
    let pins = Pins()
  ...
  func testEorZpNegative() {
    print("debug: testEorZpNegative")
    let pins = Pins()
  ...
  func testEorZpPositiveOverflow() {
    print("debug: testEorZpPositiveOverflow")
    let pins = Pins()
  ...
  func testEorZpNegativeOverflow() {
    print("debug: testEorZpNegativeOverflow")
    let pins = Pins()
